...
offsetx = 500
offsety = 500
#Make the element and radius dictionaries.
...
class Molecule(molecule.molecule):
    ...
    def parse(self, fp): 
        ...
        if not isinstance(int(molContent[0]), int) or not isinstance(int(molContent[1]), int):
            raise TypeError("Number of atoms and bonds must be integers.")
        
        atom_no = int(molContent[0])
        bond_no = int(molContent[1])
        if atom_no <= 0 or bond_no <= 0:
            raise ValueError("Number of atoms and bonds must be greater than zero.")
        ...
        for i in range(atom_no):
            ...
            try:
                ...
                raise TypeError("Invalid input types for atom coordinates or element symbol.")
        ...
        for i in range(bond_no):
            ...
            try:
                ...
                raise TypeError("Invalid input types for bond indices or electron pairs.")
